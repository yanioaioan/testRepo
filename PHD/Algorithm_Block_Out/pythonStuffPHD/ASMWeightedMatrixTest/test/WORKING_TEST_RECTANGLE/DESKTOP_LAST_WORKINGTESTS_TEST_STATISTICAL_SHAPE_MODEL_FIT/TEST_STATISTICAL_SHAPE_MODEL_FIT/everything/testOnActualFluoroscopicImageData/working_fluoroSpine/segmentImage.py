...
def createCannyEdgeImage(image):
    ...
    cv2.imwrite('canny_'+image,dst)
    print "writen %s"%('canny_'+image)
...
def main():
  ...
  i = cv.LoadImage('images/'+sys.argv[2])
  ...
  createCannyEdgeImage(sys.argv[2])
  cv.WaitKey()
  ...
  #i = cv.LoadImage('canny_'+sys.argv[2])



  m = FitModel(a, i, 'images/'+sys.argv[2], originalShapes) #'canny_'+sys.argv[2]
