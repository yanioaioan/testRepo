...
#How many extra pixels in each direction
STEP=5# NEEDS TO BE 9 when working with 10 frames sequence (10only_v1_half_res).   ----   sample every "STEP" pixels along the whisker # was 10 WORKS FOR FRANK-->6 works for fluoroTest

#Normal Profile range on each side
PIXELS_SEARCH=8# NEEDS TO BE 5 when working with 10 frames sequence (10only_v1_half_res).   ----    #COULD BE 2 # was 4    #6 work with   __createStatisticalProfileModel() & and self.__get_MAHALANOBIS()
...
class FitModel:
  ...
  #def __init__(self, asm, image, t=Point(140,45.0)):
    ...
    answer =  'initShapes' #'initShapes/ANDERST-ADAM/C5/96/512x512'  #'initShapes/ANDERST-ADAM/C5/51-75'#raw_input("where to read from under initShape ??")
