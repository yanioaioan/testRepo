...
class FitModel:
  ...
  def __init__(self, asm, image, targetImageName, originalShapes, t=Point(3,-3)):#x,y #5,85 for c3
    ...
    for imagelevel in range(self.pyramidLevels):
        ...
        if imagelevel == 0:
            ...
            gradim=gradient(gradim, 1, 1 ,5)#sobel(gradim)#
            ...
            if imageNameDownSampled==0:
                ...
                gradim=gradient(img, 1, 1 ,5)#sobel(img)#
                img=gradim
