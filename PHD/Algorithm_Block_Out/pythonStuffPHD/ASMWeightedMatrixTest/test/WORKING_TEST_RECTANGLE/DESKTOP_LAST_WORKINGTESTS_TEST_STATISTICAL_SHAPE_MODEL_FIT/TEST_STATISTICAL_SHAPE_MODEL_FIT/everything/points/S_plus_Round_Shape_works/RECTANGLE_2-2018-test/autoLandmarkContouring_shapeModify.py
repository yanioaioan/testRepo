...
sys.path.append("/home/yioannidis/Desktop/myphd_29_1_2017_continueMaster/PHD/Algorithm_Block_Out/pythonStuffPHD/ASMWeightedMatrixTest/test/WORKING_TEST_RECTANGLE/DESKTOP_LAST_WORKINGTESTS_TEST_STATISTICAL_SHAPE_MODEL_FIT/TEST_STATISTICAL_SHAPE_MODEL_FIT")
...
def recalculateTransform(new_dx, new_dy, new_degrees, direction):
    ...
    global meanshape
    meanshape = Shape.from_vector(meanshapeVector).transform(t, degreesOfRotation, CenterOfMass)
